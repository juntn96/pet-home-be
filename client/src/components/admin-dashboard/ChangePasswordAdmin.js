  ...
  _changePassword = () => {
    ...
    if (this.state.oldPassword === "" || this.state.newPassword === "") {
      if (this.state.oldPassword === "")
        this.refs.oldPassword.innerHTML = "Vui lòng không bỏ trống";
      if (this.state.newPassword === "")
        this.refs.newPassword.innerHTML = "Vui lòng không bỏ trống";
      return false;
    }
    ...
    axios
      .put(`/api/auth/changePassword`, user)
      .then(res => {
        this.setState({
          isLoading: false,
...
export default connect(
  mapStateToProps,
  {}
)(withRouter(ChangePasswordAdmin));
